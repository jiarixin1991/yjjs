...
<head>
    ...
    <style type="text/css">
        ...
        /*弹框头部颜色*/
        .layui-layer-title {
            background-color: #2293fd !important;
    ...
    <script type="text/javascript">
        $(function () {
            $(document).on("click", ".add-btn", function (e) {
                $.fn.TipsWindown.openWin("fileUploader.jsp", "上传文件", "1000px", "600px");
            });
...
<div class="layui-form">
    ...
    <div class="layui-col-md12 common_header">
        <div class="searchDiv2">
            <input type="text" id="username" name="title" placeholder="请输入用户姓名" class="layui-input inputStyle">
            <button id="search" class="layui-btn layui-btn-normal searchBtn">
                <i class="layui-icon">&#xe615;</i>查找
            </button>
            <button id="reset" class="layui-btn layui-btn-warm searchBtn">
                <i class="layui-icon">&#xe9aa;</i>重置
            </button>
        </div>

        <div class="new_btn">
            <button class="layui-btn layui-btn-normal add-btn  ">
                <i class="aliconfont">&#xe60a;</i> 上传文件
            </button>
            <button class="layui-btn layui-btn-normal add-btn2  ">
                <i class="aliconfont">&#xe60a;</i> 添加
            </button>
        </div>
        <script>
            //回车自动提交
