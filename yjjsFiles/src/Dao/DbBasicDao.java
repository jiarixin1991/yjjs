...
public interface DbBasicDao {
     ...
     * 修改信息
     * @param tableName			表名
     * @param tableMap 参数（map<要修改数据库字段,值>）
     */
   ...
   /* public List<Map<String, Object>> queryAllTable(String tableName, int pageSize, int currentPage, String sort, String sortType, String tableID) throws SQLException;*/
     ...
     * 特殊分页方式
     */
    public List<Map<String, Object>> queryAllTable(String sql, int pageSize, int currentPage, String sort, String sortType);
